...
if(EXISTS "${_MODEL_FACTORY_FILE}")
  ...
  endforeach()
  string(FIND "${_MODEL_FACTORY_CONTENT}" "lvr2::io::mesh::load(filename, {lvr2::io::mesh::Format::Ply})" _PLY_LOAD_FACADE)
  ...
  string(FIND "${_MODEL_FACTORY_CONTENT}" "lvr2::io::mesh::save(m->m_mesh, filename, {lvr2::io::mesh::Format::Ply})" _PLY_SAVE_FACADE)
  if(_PLY_SAVE_FACADE EQUAL -1)
    message(FATAL_ERROR "Private ModelFactory bridge must route mesh PLY saves through the facade")
  endif()
  string(FIND "${_MODEL_FACTORY_CONTENT}" "meshResult.error().code == lvr2::io::mesh::ErrorCode::ReadFailed" _PLY_POINT_CLOUD_FALLBACK)
