...
file(READ "${LVR2_SOURCE_DIR}/cmake/lvr-dependencies.cmake.in" _logging_policy_installed_dependencies)
string(FIND "${_logging_policy_installed_dependencies}" "find_dependency(spdlog CONFIG)" _required_spdlog_config_pos)
if(_required_spdlog_config_pos EQUAL -1)
  message(FATAL_ERROR "Installed package dependency helper must declare spdlog for the inline logging detail layer")
endif()
foreach(_config_template IN ITEMS cmake/lvr2-config.cmake.in cmake/lvr3-config.cmake.in cmake/lvr-dependencies.cmake.in)
